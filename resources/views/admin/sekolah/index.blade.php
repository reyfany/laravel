                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                           ...
                           <a href="{{route('sekolah.create')}}" class="btn btn-primary pull-right">Tambah </a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Nama Sekolah 158</th>
                                            <th>Kode Sekolah 158</th>
                                            <th>Nama Kepala Sekolah 158</th>
                                            <th>Edit</th>
                                            <th>Hapus</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('sekolah.edit', $row->id)}}" class='btn btn-primary'>Edit </a></td>
                                            <td> <form action="{{route('sekolah.destroy', $row->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
